...
And I add the describeImport endpoint to the service
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the describeExport endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the importFile endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the exportFile endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the deleteAction endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the importFromSFDC endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the uploadFromSFDC endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the exportToSFDC endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the importOnly endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the describeFile endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the processAnaplan endpoint to the service
And  I pass application/json as content type
...
Given I create a new request with https://localhost:8095/api/v1/ service
And I add the uploadFile endpoint to the service
And  I pass application/json as content type
